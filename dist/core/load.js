...
const os = require("os");
function prepareProject(obj, mods, db, pkey) {
 ...
 */
function load(path, uid_db, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        const project = yield fs.readFile(path, "utf8");
        if (project.indexOf('{') === 0) {
            ...
            const projectYAML = YAML.load(project, Object.assign({ schema: backwardsCompatible }, opts));
